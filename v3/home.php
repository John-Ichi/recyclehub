...
<head>
    ...
    <link rel="stylesheet" href="Style/home-style (2).css">
</head>
<body>
    <!-- Left Sidebar -->
    ...
    <div class="content-area">
        <div>
            <?php
            if (isset($_COOKIE['post_error'])) {
                echo $_COOKIE['post_error'];
            }
            ?>
        </div>
...
<script>
    window.addEventListener("load", () => {
        document.cookie = "post_error=; expires=Thu, 01 Jan 1970 00:00:00 UTC";
    });
</script>
